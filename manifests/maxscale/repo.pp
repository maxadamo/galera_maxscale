  ...
  unless any2bool($manage_repo) == false {
    case $::operatingsystem {
      'RedHat', 'CentOS': {
        ...
        yumrepo { 'MaxScale':
          baseurl    => "https://downloads.mariadb.com/MaxScale/${maxscale_major_version}/rhel/\$releasever/\$basearch",
      ...
      'Ubuntu': {
        ...
        apt::source { 'maxscale':
          location     => "https://downloads.mariadb.com/MaxScale/${maxscale_major_version}/ubuntu",
